...
var file_pb_proto_rawDesc = []byte{
	,
}
...
var file_pb_proto_goTypes = []interface{}{
	(*EmptyMessage)(nil),   // 0: pbs.EmptyMessage
	(*CommonResponse)(nil), // 1: pbs.CommonResponse
}
var file_pb_proto_depIdxs = []int32{
	0, // 0: pbs.CmdService.ShowConfig:input_type -> pbs.EmptyMessage
	1, // 1: pbs.CmdService.ShowConfig:output_type -> pbs.CommonResponse
...
type CmdServiceClient interface {
	ShowConfig(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*CommonResponse, error)
}
...
func (c *cmdServiceClient) ShowConfig(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*CommonResponse, error) {
	out := new(CommonResponse)
	err := c.cc.Invoke(ctx, "/pbs.CmdService/ShowConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CmdServiceServer interface {
	ShowConfig(context.Context, *EmptyMessage) (*CommonResponse, error)
}
...
func (*UnimplementedCmdServiceServer) ShowConfig(context.Context, *EmptyMessage) (*CommonResponse, error) {
...
func _CmdService_ShowConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CmdServiceServer).ShowConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pbs.CmdService/ShowConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CmdServiceServer).ShowConfig(ctx, req.(*EmptyMessage))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _CmdService_ShowConfig_Handler,
		},
	},
